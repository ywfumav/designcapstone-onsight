/*
 ...
 Reference: https://github.com/sethladd/dart-a-star/blob/master/lib/a_star.dart
*/

/*
  Reference: https://www.geeksforgeeks.org/a-search-algorithm/

  At each step, A* algorithm (A* algo) picks a node with
  the lowest 'f' function and process the node.
  f = g + h
  g = movement cost (weight of the edge)
  h = heuristic cost (estimated cost of moving to the goal)

  Ways to estimate heuristics cost:
  1) Manhattan distance
  2) Diagonal distance
  3) Euclidean distance (easiest)
*/
